        ...
        />
			...
			<div className='grid gap-6 md:grid-cols-2'>
				<UsesCard title='Dev Tools'>
					...
					/>
					<UsesItem label='Terminal' value='Warp' href='https://www.warp.dev' />
					<UsesItem label='Shell' value='Zsh' href='https://www.zsh.org' />
					<UsesItem
						label='Browser'
						value='Chrome'
						href='https://www.google.com/chrome'
					/>
					<UsesItem label='Design' value='Figma' href='https://www.figma.com' />
				</UsesCard>
				...
				<UsesCard title='Productivity'>
					...
					/>
					<UsesItem label='Tasks' value='Notion' href='https://www.notion.so' />
					<UsesItem
						label='Todo'
